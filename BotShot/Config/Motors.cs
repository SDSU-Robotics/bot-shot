...
namespace BotShot.Config {
	static public class Motors {
		...
		public static TalonSRXConfiguration ShooterTop(){
			...
			profile.slot_0.kI                       = 0.01f; //Integral Constant.     Controls the steady-state error correction.
			profile.slot_0.kD                       = 0.75f; //Derivative Constant.   Controls error oscillation.
		...
		public static TalonSRXConfiguration ShooterComArm()
		{
			...
			//PID Config
			profile.primaryPID.selectedFeedbackSensor = FeedbackDevice.Analog;
			profile.primaryPID.selectedFeedbackCoefficient = 1.0f;//0.25f;// 0.328293f;
