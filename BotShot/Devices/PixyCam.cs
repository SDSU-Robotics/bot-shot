    ...
    public class PixyCam
            {
               ...
               // OutputPort TempCS = new OutputPort(CTRE.HERO.IO.Port8.Pin5, true);
                 ...
                 */
                public PixyCam(UInt16 ClockRate, Microsoft.SPOT.Hardware.Cpu.Pin CamPin6)
                {
                    /* Constructs PixyCam */
                    SPI.Configuration PixyCam_SPIConfig = new SPI.Configuration(CamPin6, false, 0, 100, false, true, ClockRate, SPI.SPI_module.SPI4);
            ...
            public class PixyBlock
            {
                ...
                public void CopyTo(PixyBlock block)
                {
                    ...
                    Debug.Print(Signature.ToString());
                    block.X = X;
                    block.Y = Y;
                    block.Width = Width;
                    block.Height = Height;
